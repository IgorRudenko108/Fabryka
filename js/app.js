(() => {
   ...
   (() => {
       ...
       function children(selector) {
           ...
           for (let i = 0; i < this.length; i += 1) {
               ...
               for (let j = 0; j < childNodes.length; j += 1)
                   if (!selector || dom7_esm_$(childNodes[j]).is(selector)) children.push(childNodes[j]);
           }
       ...
       function updateSize() {
           ...
           let height;
           const $el = swiper.$el;
           if ("undefined" !== typeof swiper.params.width && null !== swiper.params.width) width = swiper.params.width;
           else width = $el[0].clientWidth;
           if ("undefined" !== typeof swiper.params.height && null !== swiper.params.height) height = swiper.params.height;
       ...
       function updateAutoHeight(speed) {
           ...
           if ("auto" !== swiper.params.slidesPerView && swiper.params.slidesPerView > 1)
               if (swiper.params.centeredSlides)(swiper.visibleSlides || dom([])).each((slide => {
       ...
       function updateClickedSlide(e) {
           ...
           if (slide && slideFound) {
               ...
               if (swiper.virtual && swiper.params.virtual.enabled) swiper.clickedIndex = parseInt(dom(slide).attr("data-swiper-slide-index"), 10);
       ...
       function onTouchEnd(event) {
           ...
           if (timeDiff > params.longSwipesMs) {
               ...
               if ("prev" === swiper.swipeDirection)
                   ...
                   else if (null !== rewindLastIndex && ratio < 0 && Math.abs(ratio) > params.longSwipesRatio) swiper.slideTo(rewindLastIndex);
               else swiper.slideTo(stopIndex);
           } else {
       ...
       function onResize() {
           ...
           swiper.updateSlides();
           swiper.updateSlidesClasses();
           if (("auto" === params.slidesPerView || params.slidesPerView > 1) && swiper.isEnd && !swiper.isBeginning && !swiper.params.centeredSlides) swiper.slideTo(swiper.slides.length - 1, 0, false, true);
       ...
       class Swiper {
           constructor() {
               ...
               let params;
               for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
               if (1 === args.length && args[0].constructor && "Object" === Object.prototype.toString.call(args[0]).slice(8, -1)) params = args[0];
               else [el, params] = args;
               if (!params) params = {};
           ...
           update() {
               ...
               if (swiper.params.freeMode && swiper.params.freeMode.enabled) {
                   ...
                   if (("auto" === swiper.params.slidesPerView || swiper.params.slidesPerView > 1) && swiper.isEnd && !swiper.params.centeredSlides) translated = swiper.slideTo(swiper.slides.length - 1, 0, false, true);
       ...
       function Pagination(_ref) {
           ...
           on("init", (() => {
               if (false === swiper.params.pagination.enabled) disable();
               else {
                   init();
                   render();
                   update();
       ...
       class ScrollWatcher {
           ...
           getScrollWatcherConfig(paramsWatch) {
               ...
               else if ("null" !== paramsWatch.root) this.scrollWatcherLogging(`Эмм... родительского объекта ${paramsWatch.root} нет на странице`);
...
***************************************************************************** */
       ...
       var lgQuery = function() {
           ...
           lgQuery.prototype._each = function(func) {
               ...
               if (void 0 !== this.selector.length)[].forEach.call(this.selector, func);
           ...
           lgQuery.prototype._getFirstEl = function() {
               if (this.selector && void 0 !== this.selector.length) return this.selector[0];
           ...
           lgQuery.prototype.first = function() {
               if (this.selector && void 0 !== this.selector.length) return $LG(this.selector[0]);
           ...
           lgQuery.prototype.append = function(html) {
               this._each((function(el) {
                   if ("string" === typeof html) el.insertAdjacentHTML("beforeend", html);
       ...
       var LightGallery = function() {
           ...
           LightGallery.prototype.validateLicense = function() {
               ...
               else if ("0000-0000-000-0000" === this.settings.licenseKey) console.warn("lightGallery: " + this.settings.licenseKey + " license key is not valid for production use");
           };
           ...
           LightGallery.prototype.getItemsToBeInsertedToDom = function(index, prevIndex, numberOfItems) {
               ...
               if (this.settings.loop)
                   ...
                   else if (0 === index) itemsToBeInsertedToDom.push("lg-item-" + this.lgId + "-" + (this.galleryItems.length - 1));
           ...
           LightGallery.prototype.slide = function(index, fromTouch, fromThumb, direction) {
               ...
               if (!this.lgBusy) {
                   ...
                   if (!fromTouch) this.makeSlideAnimation(direction, currentSlideItem, previousSlideItem_1);
                       ...
                       if ("prev" === direction) this.getSlideItem(touchNext).addClass("lg-next-slide");
           ...
           LightGallery.prototype.touchMove = function(startCoords, endCoords, e) {
               ...
               } else if ("vertical" === this.swipeDirection)
           ...
           LightGallery.prototype.manageSwipeClass = function() {
               ...
               if (this.settings.loop && this.galleryItems.length > 2)
                   if (0 === this.index) _touchPrev = this.galleryItems.length - 1;
           ...
           LightGallery.prototype.arrowDisable = function(index) {
               if (!this.settings.loop && this.settings.hideControlOnEnd) {
                   ...
                   if (0 === index) $prev.attr("disabled", "disabled").addClass("disabled");
       ...
       document.addEventListener("DOMContentLoaded", (function() {
           ...
           for (let elem of phone_inputs)
               for (let ev of["input", "blur", "focus"]) elem.addEventListener(ev, eventCalllback);
       }));
       ...
       for (let i = 0; i < formBtnArray.length; i++)
           if (formBtn) formBtnArray[i].addEventListener("click", (function(e) {
               e.preventDefault();
